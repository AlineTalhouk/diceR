...
[![CRAN status](http://www.r-pkg.org/badges/version/diceR)](https://cran.r-project.org/package=diceR)
[![Downloads](http://cranlogs.r-pkg.org/badges/grand-total/diceR?color=orange)](http://cran.rstudio.com/web/packages/diceR/index.html)
