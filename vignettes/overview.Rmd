...
To test whether there are four statistically distinct clusters using the PAM algorithm (with k = 4), we run `sigclust` with 50 simulations and generate a p-value for this significance test.
