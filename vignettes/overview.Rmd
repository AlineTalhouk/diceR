...
We load an expression data set from TCGA of `r nrow(hgsc)` high grade serous carcinoma samples measured on `r ncol(hgsc)` genes.
...
CC <- consensus_cluster(hgsc, nk = 3:4, pItem = 0.8, reps = 5, 
...
CC2 <- consensus_cluster(hgsc, nk = 3:4, pItem = 0.8, reps = 5, 
                         algorithms = "km")
